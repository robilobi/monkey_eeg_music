...
function interpolatedData=f_Interpolate_filter(data,flagFigs, cutoff)
...
for ip = 1:size(data,1)
    ...
    Tr = SmoothPupilWav2([timeInterpolate',Tr], cutoff);    %Applies Interpolation function %MODIFIED FA 19/12 cutoff 4hz
